...
declare module '@binance/connector' {
  ...
  export class Spot {
    ...
    avgPrice(
      symbol: string
    ): Promise<AxiosResponse<{ mins: number; price: string }>>
    exchangeInfo(options?: {
      symbol?: string
      symbols?: string[]
    }): Promise<AxiosResponse<ExchangeInformation>>

    // Trade
    account(options?: {
      recvWindow?: number
    }): Promise<AxiosResponse<AccountInformation>>
    newOrderTest(
      symbol: string,
      side: OrderSide,
      type: OrderType,
    ...
    newOrder<
      NewOrderResponseType extends
        | NewOrderResponseAck
        | NewOrderResponseResult
        | NewOrderResponseFull = NewOrderResponseFull
    >(
      symbol: string,
      side: OrderSide,
      type: OrderType,
